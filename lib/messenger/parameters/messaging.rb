  ...
  module Parameters
    class Messaging
      ...
      def initialize(sender:, recipient:, timestamp: nil, message: nil, delivery: nil, postback: nil, optin: nil, read: nil, account_linking: nil, quick_reply: nil)
        ...
        @callback     = set_callback(message: message, delivery: delivery, postback: postback, optin: optin, read: read, account_linking: account_linking, quick_reply: quick_reply)
      end
